...
from core.views import manage_request
from core.views import manage_42_api_step1
from core.views import manage_42_api_step2
from core.views import create_account
from core.views import logout
from core.views import match_end
from core.views import log_in
from core.views import get_best_players
from core.views import get_global_stats
from core.views import get_solo_stats
from core.views import get_duo_stats
from core.views import get_tournament_stats
from core.views import get_victories
from core.views import get_defeats
from core.views import get_victories_mode
from core.views import get_points_by_match
from core.views import get_match_stats
from core.views import is_user_signed_in
from core.views import get_avatar
from core.views import post_avatar
from core.views import get_requests
from core.views import post_decline_request
from core.views import post_remove_friend
from core.views import post_add_friend
from core.views import get_friends_list
#from core.views import post_42api
from core.views import post_username
from core.views import post_password
from core.views import tournament_end
from core.views import set_block
from core.views import get_block
